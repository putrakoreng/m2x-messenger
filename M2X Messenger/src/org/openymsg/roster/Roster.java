...
////    	{
////    		String groupName = user.getGroupIds().toArray()[0].toString();
////    		if (!groups.containsKey(groupName))
////    		{
////    			
////    			ArrayList<YahooUser> usersInGroup = new ArrayList<YahooUser>();
////    			for(YahooUser i: usersById.values())
////    			{
////    				if (i.getGroupIds().toArray()[0].toString() == groupName)
////    					usersInGroup.add(i);
////    			}
////    			
////    			Collections.sort(usersInGroup, new Comparator<YahooUser>()
////				{
////
////					@Override
