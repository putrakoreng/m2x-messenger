...
public class ChatWindowPager extends FragmentActivity
{
	...
	{		
		...
		public Fragment getItem(final int arg0)
		{
			...
			Log.d("M2X", "Fragment created for : " + friendId);
			return f;
		}
		...
		public View getView(final int position)
		{
			...
			Log.d("M2X", "View #" + position + " returned for : " + friendId);
			YahooUser user = null;
	...
	public boolean onOptionsItemSelected(final MenuItem item)
	{
		if (item.getItemId() == R.id.mnuClose)
		{
			 ...
			 * removing the fragment and selecting another fragment
			 * will not destroy the already instantiated one
			 * and therefore will cause some UI bugs.
